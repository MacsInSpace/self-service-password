...
#DET errors
$messages['edumailservererror'] = "Cannot reach eduMail server. Try again later.";
$messages['hiddenarealoginrequired'] = "Must specify your eduMail UserID.";
$messages['hiddenareapasswordrequired'] = "Must specify a new eduMail password.";
$messages['Change Password Success'] = "DET: eduMail change Password Success";
$messages['Your eduMail UserID and eduMail Password are incorrect.'] = "DET: Your eduMail UserID and eduMail Password are incorrect.";
$messages['Must specify your eduMail UserID.'] = "DET: Must specify your eduMail UserID.";
$messages['Must specify a new password.'] = "DET: Must specify a new eduMail password.";
$messages['The passwords you typed do not match.'] = "DET: The new passwords you typed do not match.";
$messages['This password is not valid. Passwords must contain a minimum of seven characters and maximum of 32 characters.'] = "DET: This password is not valid. eduMail passwords must contain a minimum of seven characters and maximum of 32 characters.";
$messages['New Password must be different from your last eight passwords.<br> And your password cannot be changed more than once in 24 hours.'] = "DET: New eduMail Password must be different from your last eight passwords.<br>And your password cannot be changed more than once in 24 hours.";
$messages['New Password must contain at least one character from at least three of the following sets:<br> lowercase (a-z), uppercase (A-Z), numerals (0-9) or special characters (~`#$*@^)'] = "DET: New Password must contain at least one character from at least three of the following sets: lowercase (a-z), uppercase (A-Z), numerals (0-9) or special characters (~`#$*@^)";
