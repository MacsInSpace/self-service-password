...
$messages['hiddenareapasswordrequired'] = "Your eduMail password is required";
$messages['hiddenarealoginrequired'] = "Your eduMail login is required";
$messages['Change Password Success'] = "Change Password Success";
$messages['Your eduMail UserID and eduMail Password are incorrect.'] = "Your eduMail UserID and eduMail Password are incorrect.";
$messages['Must specify your eduMail UserID.'] = "Must specify your eduMail UserID.";
$messages['Must specify a new password.'] = "Must specify a new password.";
$messages['The passwords you typed do not match.'] = "The passwords you typed do not match.";
$messages['This password is not valid. Passwords must contain a minimum of seven characters and maximum of 32 characters.'] = "This password is not valid. Passwords must contain a minimum of seven characters and maximum of 32 characters.";
$messages['New Password must be different from your last eight passwords.<br>And your password cannot be changed more than once in 24 hours.'] = "New Password must be different from your last eight passwords.<br>And your password cannot be changed more than once in 24 hours.";
$messages['New Password must contain at least one character from at least three of the following sets: lowercase (a-z), uppercase (A-Z), numerals (0-9) or special characters (~`#$*@^)'] = "New Password must contain at least one character from at least three of the following sets: lowercase (a-z), uppercase (A-Z), numerals (0-9) or special characters (~`#$*@^)";
